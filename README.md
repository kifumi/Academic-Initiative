...
プロモコードの適用で、  
* IBM Cloudの使用期限の延長（先生：１年まで、学生：半年まで。期限が切れる前に更新可能。）  
* APIやサービスを標準プランで使用すること（通常、標準プランを使うにはクレジットカード登録が必要ですが、登録の必要なく使えます。）  
...
<img src="Images/OnTheHub_Cloud.png" width="500">
...
<img src="Images/OnTheHub_Cloud2.png" width="400">
...
<img src="Images/SeikyuShori.png" width="400">  
画面中ほどの「フィーチャー (割引) コード」のエリアで「コードの適用」をクリックし、4.で取得したプロモコードをコピペして「適用」をクリックします。  
<img src="Images/FeatureCode.png" width="400"> 
